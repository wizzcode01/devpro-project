...
//             {/* Blog Content */}
//             <div
//               className="relative group md:col-span-3 p-4 rounded-2xl"
...
//             {/* Uses (only if exists) */}
//             {post.uses && (
//               <div className="md:col-span-1 flex flex-col gap-4 text-start text-white p-4 border border-zinc-700 rounded-xl">
